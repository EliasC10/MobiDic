...
Client.create(name: "zwei", date_of_birth: "01.91.2016", institution_id: 2)
...
Entry.create(text: "Fischen", supervisor_id: 3)

ClientEntry.create(client_id: 1, entry_id: 1)
ClientEntry.create(client_id: 1, entry_id: 2)
ClientEntry.create(client_id: 2, entry_id: 2)
ClientEntry.create(client_id: 1, entry_id: 3)
ClientEntry.create(client_id: 3, entry_id: 4)
...
EntryCategory.create(entry_id: 1, category_id: 2)
EntryCategory.create(entry_id: 2, category_id: 2)
EntryCategory.create(entry_id: 3, category_id: 3)
EntryCategory.create(entry_id: 4, category_id: 1)
